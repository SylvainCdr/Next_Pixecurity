...
function CartItem({ cart }) {
  ...
  const [localQuantity, setLocalQuantity] = React.useState(cart.quantity);

  useEffect(() => {
    setLocalQuantity(cart.quantity); // synchroniser si la quantité change depuis le contexte
  }, [cart.quantity]);
  ...
  const handleQuantityBlur = () => {
    ...
    addToCart(product, newQuantity); // mettre à jour le contexte
  };
    ...
    <div className={styles.product}>
      ...
      <div className={styles["product-details"]}>
        <div className={styles["product-title"]}>
          <Link href={`boutique/produit/${product._id}/${userIdParam}`}>
            {" "}
            {product.name}{" "}
          </Link>
          <p>Réf : {product.ref}</p>
    ...
    -{product.pourcentageDiscount}%
      ...
      <div className={styles["product-quantity"]}>
        <input
          ...
          onBlur={handleQuantityBlur} // envoyer update au serveur / contexte
        />
      </div>
