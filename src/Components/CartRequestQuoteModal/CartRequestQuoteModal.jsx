      ...
      const requestData = {
       name: formData.get("name"),
        ...
        cartItems: carts.map((cart) => ({
          ...
          totalPrice: (cart.quantity * (cart.product.discountPrice || cart.product.price)).toFixed(2),
        })),
      };
...
function QuoteRequestForm({ onSubmit }) {
  return (
    <form onSubmit={onSubmit}>
      ...
      <h3>  Veuillez remplir le formulaire ci-dessous pour recevoir un devis personnalisé pour votre panier </h3>
